...
import aries.financial.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/aries-club-member-kafka")
public class AriesClubMemberKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AriesClubMemberKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public AriesClubMemberKafkaResource(KafkaProperties kafkaProperties) {
