			...
			return (
				<div className={ classes.root }>
					<div className={ classes.investedContainerLoggedOut }>
						<Typography variant={'h5'} className={ classes.disaclaimer }>{i18next.t("Zap.Text.1")}</Typography>
						<div className={ classes.introCenter }>
							<Typography variant='h3'>{i18next.t("Zap.NotLogin")}</Typography>
						</div>
					</div>
		...
		return (
			<div className={ classes.root }>
				<div className={ classes.card }>
					<Typography variant={'h5'} className={ classes.disaclaimer }>{i18next.t("Zap.Text.2")}</Typography>
					<Card className={ classes.iHaveContainer }>
						...
						{ (sendAsset && receiveAsset && !(['crvV3', 'crvV4'].includes(receiveAsset.id) && ['crvV1', 'crvV2', 'crvV3'].includes(sendAsset.id)) && !(sendAsset && sendAsset.symbol === 'ETH')) && <Button
							...
							fullWidth
						>
							<Typography className={ classes.buttonText } variant={ 'h5'} color='secondary'>{i18next.t("Zap.Text.3")}</Typography>
						</Button> }
						{ (sendAsset && receiveAsset && ['crvV3', 'crvV4'].includes(receiveAsset.id) && ['crvV1', 'crvV2', 'crvV3'].includes(sendAsset.id)) && <Button
							...
							fullWidth
						>
							<Typography className={ classes.buttonText } variant={ 'h5'} color='secondary'>{i18next.t("Zap.Text.4")}</Typography>
						</Button> }
