//i18n => {"vault.vault.Text.1":"This project is in beta. Use at your own risk.","vault.vault.Text.2":"Connect your wallet to continue","vault.vault.Text.3":"This project is in beta. Use at your own risk.","vault.vault.Text.4":" on ","vault.vault.Text.5":"Not Available"}
  			...
  			<Accordion className={ classes.expansionPanel } square key={ asset.id+"_expand" } expanded={ expanded === asset.id} onChange={ () => { this.handleChange(asset.id); } }>
                ...
                <div className={classes.headingEarning}>
                	...
                	<div className={ classes.flexy }>
                		...
                		<Typography variant={ 'h5' } className={ classes.on } id="vault.vault.Text.4" >{i18next.t('vault.vault.Text.4')}</Typography>
                ...
                <div className={classes.headingEarning}>
                	<Typography variant={ 'h5' } className={ classes.grey }>Yearly Growth:</Typography>
                	<Typography variant={ 'h3' } noWrap id="vault.vault.Text.5" >{i18next.t('vault.vault.Text.5')}</Typography>
                </div>
  						}
