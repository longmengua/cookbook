//i18n => {"vault.asset.Text.1":"Deposits are currently disabled for this vault","vault.asset.Text.2":"Withdraw","vault.asset.Text.3":"Withdraw All"}
  	...
  	return (
  		<div className={ classes.vaultContainer }>
              ...
              <div className={classes.disabledContainer}>
              	<Typography variant='h4' id="vault.asset.Text.1" >{i18next.t('vault.asset.Text.1')}</Typography>
              </div>
  					}
  				</div>
                ...
                <Button
                	...
                	fullWidth
                >
                	<Typography className={ classes.buttonText } variant={ 'h5'} color='secondary' id="vault.asset.Text.2" >{i18next.t('vault.asset.Text.2')}</Typography>
                </Button>
  						}
                ...
                <Button
                	...
                	fullWidth
                >
                	<Typography className={ classes.buttonText } variant={ 'h5'} color='secondary' id="vault.asset.Text.3" >{i18next.t('vault.asset.Text.3')}</Typography>
                </Button>
  						}
  					</div>
  				</div>
