//i18n => {"performance.performance.Text.1":"ROI","performance.performance.Text.2":"Block","performance.performance.Text.3":"ETH","performance.performance.Text.4":"iETH","performance.performance.Text.5":"ETH Redeem"}
  		...
  		<div className={ classes.root }>
  			<div className={ classes.investedContainer }>
  				<div className={ classes.intro }>
  					<Typography variant='h3' id="performance.performance.Text.1" >{i18next.t('performance.performance.Text.1')}</Typography>
  				</div>
  	...
  	return (
  		<div key={ 'name' } className={ classes.pair }>
  			<div className={ classes.headerName }>
  				<Typography align='left' variant={'h3'} id="performance.performance.Text.2" >{i18next.t('performance.performance.Text.2')}</Typography>
  			</div>
  			<div className={ classes.headerApr }>
  				<Typography variant={'h3'} align='right' id="performance.performance.Text.3" >{i18next.t('performance.performance.Text.3')}</Typography>
  			</div>
  			<div className={ classes.headerApr }>
  				<Typography variant={'h3'} align='right' id="performance.performance.Text.4" >{i18next.t('performance.performance.Text.4')}</Typography>
  			</div>
  			<div className={ classes.headerApr }>
  				<Typography variant={'h3'} align='right' id="performance.performance.Text.5" >{i18next.t('performance.performance.Text.5')}</Typography>
  			</div>
  			<div className={ classes.headerApr }>
