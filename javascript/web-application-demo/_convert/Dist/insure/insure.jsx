//i18n => {"insure.insure.Text.1":"This project is in beta. Use at your own risk.","insure.insure.Text.2":"Wallet","insure.insure.Text.3":"{ t('Zap.Intro') }","insure.insure.Text.4":"{ t('Insure.Intro') }","insure.insure.Text.5":"{ t('InvestSimple.Connect') }","insure.insure.Text.6":"{ t('Insure.Balance') }","insure.insure.Text.7":"{ t('Insure.Insured') }"}
  	...
  	return (
  		<div className={ classes.root }>
  			<div className={ classes.insuranceContainer }>
  				<Typography variant={'h5'} className={ classes.disaclaimer } id="insure.insure.Text.1" >{i18next.t('insure.insure.Text.1')}</Typography>
            ...
            <div className={ classes.intro }>
            	...
            	<Card className={ classes.addressContainer } onClick={this.overlayClicked}>
            		<Typography variant={ 'h3'} className={ classes.walletTitle } noWrap id="insure.insure.Text.2" >{i18next.t('insure.insure.Text.2')}</Typography>
            ...
            <div className={ classes.actualIntro }>
            	<Typography variant='h3' id="insure.insure.Text.3" >{i18next.t('insure.insure.Text.3')}</Typography>
            </div>
  				}
  				{ (!account || !account.address) &&
            <div className={ classes.introCenter }>
            	<Typography variant='h3' id="insure.insure.Text.4" >{i18next.t('insure.insure.Text.4')}</Typography>
            </div>
  				}
            ...
            <div className={ classes.connectContainer }>
            	...
            	>
            		<Typography className={ classes.buttonText } variant={ 'h5'} id="insure.insure.Text.5" >{i18next.t('insure.insure.Text.5')}</Typography>
            	</Button>
            </div>
  				}
  				...
  				>
  					<div className={ classes.assetSummary }>
  						...
  						<div className={classes.heading}>
  							...
  							<Typography variant={ 'h5' } className={ classes.grey } id="insure.insure.Text.6" >{i18next.t('insure.insure.Text.6')}</Typography>
  						</div>
  						<div className={classes.heading}>
  							...
  							<Typography variant={ 'h5' } className={ classes.grey } id="insure.insure.Text.7" >{i18next.t('insure.insure.Text.7')}</Typography>
  						</div>
  					</div>
  				</ExpansionPanelSummary>
  				<ExpansionPanelDetails>
