//i18n => {"insure.insuredAsset.Text.1":"{ t('Insure.TotalCost') }","insure.insuredAsset.Text.2":"{ t('Insure.Expiration') }","insure.insuredAsset.Text.3":"{ t('Insure.Premium') }","insure.insuredAsset.Text.4":"{ t('Insure.ExpectedReturns') }","insure.insuredAsset.Text.5":"{ t('Insure.TokensMinted') }","insure.insuredAsset.Text.6":"{ t('Insure.CostPerToken') }","insure.insuredAsset.Text.7":"{ t('Insure.CollateralizationRatio') }","insure.insuredAsset.Text.8":"{ t('Insure.MinimumCollateralizationRatio') }"}
  ...
  render() {
  	...
  	return (<div className={ classes.actionsContainer }>
  		...
  		<div className={ `${classes.tradeContainer}` }>
  			<div className={ classes.tradeContainerInfo }>
  				<div className={ classes.infoContainer } >
  					<Typography variant={'h3'} id="insure.insuredAsset.Text.1" >{i18next.t('insure.insuredAsset.Text.1')}</Typography>
  					<Typography variant={'h3'}>{ (amount*(pricePerInsurance !== null ? pricePerInsurance : asset.pricePerInsurance)).toFixed(4) + ' ETH' }</Typography>
  				</div>
  				<div className={ classes.infoContainer } >
  					<Typography variant={'h5'} id="insure.insuredAsset.Text.2" >{i18next.t('insure.insuredAsset.Text.2')}</Typography>
  					<Typography variant={'h4'}>{asset.expiryBlock ? moment(asset.expiryBlock, 'X').fromNow() : t('Insure.Unknown')}</Typography>
  				</div>
  				<div className={ classes.infoContainer } >
  					<Typography variant={'h5'} id="insure.insuredAsset.Text.3" >{i18next.t('insure.insuredAsset.Text.3')}</Typography>
  				...
  				<div className={ classes.infoContainer } >
  					<Typography variant={'h5'} id="insure.insuredAsset.Text.4" >{i18next.t('insure.insuredAsset.Text.4')}</Typography>
  		...
  		<div className={ `${classes.tradeContainer}` }>
  			<div className={ classes.tradeContainerInfo }>
  				<div className={ classes.infoContainer } >
  					<Typography variant={'h3'} id="insure.insuredAsset.Text.5" >{i18next.t('insure.insuredAsset.Text.5')}</Typography>
  					<Typography variant={'h3'}>{ maxTokens.toFixed(4) + ' '+asset.insuredSymbol }</Typography>
  				</div>
  				<div className={ classes.infoContainer } >
  					<Typography variant={'h5'} id="insure.insuredAsset.Text.6" >{i18next.t('insure.insuredAsset.Text.6')}</Typography>
  					<Typography variant={'h4'}>{ (asset.tokenPrice).toFixed(4) + ' ETH' }</Typography>
  				</div>
  				<div className={ classes.infoContainer } >
  					<Typography variant={'h5'} id="insure.insuredAsset.Text.7" >{i18next.t('insure.insuredAsset.Text.7')}</Typography>
  					<Typography variant={'h4'}>{'200%'}</Typography>
  				</div>
  				<div className={ classes.infoContainer } >
  					<Typography variant={'h5'} id="insure.insuredAsset.Text.8" >{i18next.t('insure.insuredAsset.Text.8')}</Typography>
