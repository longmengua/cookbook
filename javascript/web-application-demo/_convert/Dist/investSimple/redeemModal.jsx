//i18n => {"investSimple.redeemModal.Text.1":"Tell us how much iEth you would like to redeem. Once you press submit, you will need to approve the transaction in MetaMask.","investSimple.redeemModal.Text.2":"Cancel","investSimple.redeemModal.Text.3":"Submit"}
  		...
  		<Dialog open={ true } onClose={ closeModal } fullWidth={ true } maxWidth={ 'sm' } TransitionComponent={ Transition } fullScreen={ fullScreen }>
  			<DialogContent>
  				<div className={ classes.intro }>
  					<Typography variant='h3' id="investSimple.redeemModal.Text.1" >{i18next.t('investSimple.redeemModal.Text.1')}</Typography>
  				</div>
  				...
  				<div className={ classes.actionsContainer }>
  					<Button
  						...
  						onClick={ closeModal }
  					>
  						<Typography className={ classes.buttonText } variant={ 'h3'} id="investSimple.redeemModal.Text.2" >{i18next.t('investSimple.redeemModal.Text.2')}</Typography>
  					</Button>
  					<Button
  						className={ classes.actionButton }
  						variant="contained"
  					...
  					>
  						<Typography className={ classes.buttonText } variant={ 'h3'} color='secondary' id="investSimple.redeemModal.Text.3" >{i18next.t('investSimple.redeemModal.Text.3')}</Typography>
  					</Button>
  				</div>
  			</DialogContent>
  		</Dialog>
