//i18n => {"investSimple.compAsset.Text.1":"{ t('Asset.Withdraw') }","investSimple.compAsset.Text.2":"{ t('Asset.ClaimRewards') }"}
  	...
  	return (<div className={ classes.actionsContainer }>
  		...
  		<div className={classes.tradeContainer}>
  			...
  			<Button
  				...
  				fullWidth
  			>
  				<Typography className={ classes.buttonText } variant={ 'h5'} color='secondary' id="investSimple.compAsset.Text.1" >{i18next.t('investSimple.compAsset.Text.1')}</Typography>
  			</Button>
  		</div>
  		<div className={ classes.sepperator }></div>
  		<div className={classes.fullWidth}>
  			<Button
  				...
  				fullWidth
  			>
  				<Typography className={ classes.buttonText } variant={ 'h5'} color='secondary' id="investSimple.compAsset.Text.2" >{i18next.t('investSimple.compAsset.Text.2')}</Typography>
  			</Button>
  		</div>
  	</div>);
  };
