//i18n => {"investSimple.investAllModal.Text.1":"Cancel","investSimple.investAllModal.Text.2":"Earn All"}
  			...
  			<DialogContent>
  				...
  				<div className={ classes.actionsContainer }>
  					<Button
  						...
  						onClick={ closeModal }
  					>
  						<Typography className={ classes.buttonText } variant={ 'h3'} id="investSimple.investAllModal.Text.1" >{i18next.t('investSimple.investAllModal.Text.1')}</Typography>
  					</Button>
  					<Button
  						className={ classes.actionButton }
  						variant="contained"
  					...
  					>
  						<Typography className={ classes.buttonText } variant={ 'h3'} color='secondary' id="investSimple.investAllModal.Text.2" >{i18next.t('investSimple.investAllModal.Text.2')}</Typography>
  					</Button>
  				</div>
  			</DialogContent>
  			{ loading && <Loader /> }
