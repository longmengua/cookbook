//i18n => {"investSimple.investModal.Text.1":"Awesome, tell us how much Eth you would like to invest. Once you press submit, you will need to approve the transaction in MetaMask and you will be earning interest on your Eth.","investSimple.investModal.Text.2":"Cancel","investSimple.investModal.Text.3":"Submit"}
  		...
  		<Dialog open={ true } onClose={ closeModal } fullWidth={ true } maxWidth={ 'sm' } TransitionComponent={ Transition } fullScreen={ fullScreen }>
  			<DialogContent>
  				<div className={ classes.intro }>
  					<Typography variant='h3' id="investSimple.investModal.Text.1" >{i18next.t('investSimple.investModal.Text.1')}</Typography>
  				</div>
  				...
  				<div className={ classes.actionsContainer }>
  					<Button
  						...
  						onClick={ closeModal }
  					>
  						<Typography className={ classes.buttonText } variant={ 'h3'} id="investSimple.investModal.Text.2" >{i18next.t('investSimple.investModal.Text.2')}</Typography>
  					</Button>
  					<Button
  						className={ classes.actionButton }
  						variant="contained"
  					...
  					>
  						<Typography className={ classes.buttonText } variant={ 'h3'} color='secondary' id="investSimple.investModal.Text.3" >{i18next.t('investSimple.investModal.Text.3')}</Typography>
  					</Button>
  				</div>
  			</DialogContent>
  			{ loading && <Loader /> }
