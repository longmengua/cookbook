//i18n => {"investSimple.asset.Text.1":"{ t('Asset.Claim') }"}
  	...
  	return (<div className={ classes.actionsContainer }>
  		...
  		<div className={classes.tradeContainer}>
  			...
  			<Button
  				...
  				fullWidth
  			>
  				<Typography className={ classes.buttonText } variant={ 'h5'} color='secondary' id="investSimple.asset.Text.1" >{i18next.t('investSimple.asset.Text.1')}</Typography>
  			</Button>
  		</div>
  	</div>);
  };
