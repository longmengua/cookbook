//i18n => {"idai.want.Text.1":"I will receive"}
		...
		return (
			<div className={ classes.root }>
				<div className={ classes.inputCard }>
					<Typography variant='h3' className={ classes.inputCardHeading } id="idai.want.Text.1" >{i18next.t('idai.want.Text.1')}</Typography>
