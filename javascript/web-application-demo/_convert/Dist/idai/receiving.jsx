//i18n => {"idai.receiving.Text.1":"Receive amount"}
		...
		return (
			<div className={ classes.root }>
				<div className={ classes.inputCard }>
					<Typography variant='h3' className={ classes.inputCardHeading } id="idai.receiving.Text.1" >{i18next.t('idai.receiving.Text.1')}</Typography>
