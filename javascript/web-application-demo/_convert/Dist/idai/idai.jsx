//i18n => {"idai.idai.Text.1":"{ t('IDai.Intro') }","idai.idai.Text.2":"{ t('InvestSimple.Connect') }","idai.idai.Text.3":"{ t('IDai.Intro') }","idai.idai.Text.4":"{ t('IDai.Swap') }"}
  	...
  	return (
          ...
          <div className={ classes.investedContainer }>
          	<div className={ classes.introCenter }>
          		<Typography variant='h3' id="idai.idai.Text.1" >{i18next.t('idai.idai.Text.1')}</Typography>
          	</div>
          	<div className={ classes.connectContainer }>
          		...
          		>
          			<Typography className={ classes.buttonText } variant={ 'h5'} id="idai.idai.Text.2" >{i18next.t('idai.idai.Text.2')}</Typography>
          		</Button>
          	</div>
          </div>
  			}
          ...
          <div className={ classes.card }>
          	<div className={ classes.introCenter }>
          		<Typography variant='h3' id="idai.idai.Text.3" >{i18next.t('idai.idai.Text.3')}</Typography>
          	</div>
          	<Card className={ classes.iHaveContainer }>
          		...
          		{ (!receiveAsset || receiveAsset.symbol !== 'CurveV3') && <Button
          			...
          			fullWidth
          		>
          			<Typography className={ classes.buttonText } variant={ 'h5'} color='secondary' id="idai.idai.Text.4" >{i18next.t('idai.idai.Text.4')}</Typography>
          		</Button> }
          	</Card>
          	<div className={ classes.introCenter }>
          	</div>
