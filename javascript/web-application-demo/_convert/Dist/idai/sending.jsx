//i18n => {"idai.sending.Text.1":"Send amount"}
		...
		return (
			<div className={ classes.root }>
				<div className={ classes.inputCard }>
					<Typography variant='h3' className={ classes.inputCardHeading } id="idai.sending.Text.1" >{i18next.t('idai.sending.Text.1')}</Typography>
