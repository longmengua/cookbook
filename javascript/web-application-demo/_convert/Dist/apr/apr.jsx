//i18n => {"apr.apr.Text.1":"{ 'Vault' }","apr.apr.Text.2":"{ 'Current Strategy' }","apr.apr.Text.3":"{ 'Vault holdings' }","apr.apr.Text.4":"{ 'Strategy holdings' }","apr.apr.Text.5":"{ 'Token' }","apr.apr.Text.6":"{ 'USD' }","apr.apr.Text.7":"{ 'ROI based on sampled period' }","apr.apr.Text.8":"{ '1 Week' }","apr.apr.Text.9":"{ '1 Month' }","apr.apr.Text.10":"{ 'Inception' }"}
  	...
  	return (
  		<tr className={ classes.pair }>
  			<th className={ classes.headerName }>
  				<Typography  align='right' variant={'h4'} className={classes.aggregatedHeader} id="apr.apr.Text.1" >{i18next.t('apr.apr.Text.1')}</Typography>
  			</th>
  			<th className={ classes.headerStrategy }>
  				<Typography  align='right' variant={'h4'} className={classes.aggregatedHeader} id="apr.apr.Text.2" >{i18next.t('apr.apr.Text.2')}</Typography>
  			</th>
  			<th className={ classes.headerValue }>
  				<Typography  align='right' variant={'h4'} className={classes.aggregatedHeaderRight} id="apr.apr.Text.3" >{i18next.t('apr.apr.Text.3')}</Typography>
  			</th>
  			<th className={ classes.headerValue }>
  				<Typography  align='right' variant={'h4'} className={classes.aggregatedHeaderRight} id="apr.apr.Text.4" >{i18next.t('apr.apr.Text.4')}</Typography>
  			</th>
  			<th className={ classes.headerHoldings }>
  				...
  				<div className={ classes.subHeader }>
  					<div className={ classes.headerValue }>
  						<Typography  align='right' variant={'h4'} className={classes.aggregatedHeaderRight} id="apr.apr.Text.5" >{i18next.t('apr.apr.Text.5')}</Typography>
  					</div>
  					<div className={ classes.headerValue }>
  						<Typography  align='right' variant={'h4'} className={classes.aggregatedHeaderRight} id="apr.apr.Text.6" >{i18next.t('apr.apr.Text.6')}</Typography>
  					</div>
  				</div>
  			</th>
  			<th className={ classes.headerROI }>
  				<Typography  align='right' variant={'h4'} className={classes.aggregatedHeaderCenter} id="apr.apr.Text.7" >{i18next.t('apr.apr.Text.7')}</Typography>
  				<div className={ classes.subHeader }>
  					<div className={ classes.headerValue }>
  						<Typography  align='right' variant={'h4'} className={classes.aggregatedHeaderRight} id="apr.apr.Text.8" >{i18next.t('apr.apr.Text.8')}</Typography>
  					</div>
  					<div className={ classes.headerValue }>
  						<Typography  align='right' variant={'h4'} className={classes.aggregatedHeaderRight} id="apr.apr.Text.9" >{i18next.t('apr.apr.Text.9')}</Typography>
  					</div>
  					<div className={ classes.headerValue }>
  						<Typography  align='right' variant={'h4'} className={classes.aggregatedHeaderRight} id="apr.apr.Text.10" >{i18next.t('apr.apr.Text.10')}</Typography>
  					</div>
  				</div>
  			</th>
  		</tr>
