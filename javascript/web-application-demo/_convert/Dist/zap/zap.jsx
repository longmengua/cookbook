//i18n => {"zap.zap.Text.1":"This project is in beta. Use at your own risk.","zap.zap.Text.2":"Connect your wallet to continue","zap.zap.Text.3":"This project is in beta. Use at your own risk.","zap.zap.Text.4":"{ t('Zap.Zap') }","zap.zap.Text.5":"{ t('Zap.Swap') }","zap.zap.Text.6":"{ t('Zap.Trade') }"}
  		...
  		return (
  			<div className={ classes.root }>
  				<div className={ classes.investedContainerLoggedOut }>
  					<Typography variant={'h5'} className={ classes.disaclaimer } id="zap.zap.Text.1" >{i18next.t('zap.zap.Text.1')}</Typography>
  					<div className={ classes.introCenter }>
  						<Typography variant='h3' id="zap.zap.Text.2" >{i18next.t('zap.zap.Text.2')}</Typography>
  					</div>
  				</div>
  	...
  	return (
  		<div className={ classes.root }>
  			<div className={ classes.card }>
  				<Typography variant={'h5'} className={ classes.disaclaimer } id="zap.zap.Text.3" >{i18next.t('zap.zap.Text.3')}</Typography>
              ...
              <ConversionRatios bestPrice={ bestPrice } sendAsset={ sendAsset } receiveAsset={ receiveAsset } />
  					...
  					{ (sendAsset && receiveAsset && !(['crvV3', 'crvV4'].includes(receiveAsset.id) && ['crvV1', 'crvV2', 'crvV3'].includes(sendAsset.id)) && !(sendAsset && sendAsset.symbol === 'ETH')) && <Button
  						...
  						fullWidth
  					>
  						<Typography className={ classes.buttonText } variant={ 'h5'} color='secondary' id="zap.zap.Text.4" >{i18next.t('zap.zap.Text.4')}</Typography>
  					</Button> }
  					{ (sendAsset && receiveAsset && ['crvV3', 'crvV4'].includes(receiveAsset.id) && ['crvV1', 'crvV2', 'crvV3'].includes(sendAsset.id)) && <Button
  						...
  						fullWidth
  					>
  						<Typography className={ classes.buttonText } variant={ 'h5'} color='secondary' id="zap.zap.Text.5" >{i18next.t('zap.zap.Text.5')}</Typography>
  					</Button> }
  					{ (sendAsset && sendAsset.symbol === 'ETH') && <Button
  						...
  						fullWidth
  					>
  						<Typography className={ classes.buttonText } variant={ 'h5'} color='secondary' id="zap.zap.Text.6" >{i18next.t('zap.zap.Text.6')}</Typography>
  					</Button> }
  				</Card>
  				<div className={ classes.introCenter }>
  				</div>
