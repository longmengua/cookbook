//i18n => {"zap.receiving.Text.1":"Receive amount"}
		...
		return (
			<div className={ classes.root }>
				<div className={ classes.inputCard }>
					<Typography variant='h3' className={ classes.inputCardHeading } id="zap.receiving.Text.1" >{i18next.t('zap.receiving.Text.1')}</Typography>
