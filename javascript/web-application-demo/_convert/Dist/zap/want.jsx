//i18n => {"zap.want.Text.1":"{ t(\"Zap.IWillReceive\") }","zap.want.Text.2":"{ 'TUSD' }"}
		...
		return (
			<div className={ classes.root }>
				<div className={ classes.inputCard }>
					...
					<Typography variant='h3' className={ classes.inputCardHeading } id="zap.want.Text.1" >{i18next.t('zap.want.Text.1')}</Typography>
  				...
  				</div>
  				{
  					(sendAsset && sendAsset.id === 'crvV3' && option.id === 'crvV4') &&(
  						<React.Fragment>
  							...
  							<div className={ classes.assetSelectIconName }>
  								<Typography variant='h4' id="zap.want.Text.2" >{i18next.t('zap.want.Text.2')}</Typography>
  							</div>
  						</React.Fragment>)
  				}
  			</React.Fragment>
