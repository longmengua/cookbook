//i18n => {"zap.sending.Text.1":"{ t(\"Zap.SendAmount\") }"}
		...
		return (
			<div className={ classes.root }>
				<div className={ classes.inputCard }>
					<Typography variant='h3' className={ classes.inputCardHeading } id="zap.sending.Text.1" >{i18next.t('zap.sending.Text.1')}</Typography>
