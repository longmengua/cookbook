//i18n => {"dashboard.dashboard.Text.1":"This project is in beta. Use at your own risk.","dashboard.dashboard.Text.2":"Connect your wallet to continue","dashboard.dashboard.Text.3":"ETH","dashboard.dashboard.Text.4":"Portfolio Balance","dashboard.dashboard.Text.5":"ETH","dashboard.dashboard.Text.6":"\n                  Daily Growth\n              \t","dashboard.dashboard.Text.7":"ETH","dashboard.dashboard.Text.8":"\n                  Weekly Growth\n              \t","dashboard.dashboard.Text.9":"ETH","dashboard.dashboard.Text.10":"\n                  Yearly Growth\n              \t","dashboard.dashboard.Text.11":"Vaults Overview","dashboard.dashboard.Text.12":"Earn Overview","dashboard.dashboard.Text.13":"Daily Growth","dashboard.dashboard.Text.14":"ETH","dashboard.dashboard.Text.15":"Weekly Growth","dashboard.dashboard.Text.16":"ETH","dashboard.dashboard.Text.17":"Yearly Growth","dashboard.dashboard.Text.18":"ETH","dashboard.dashboard.Text.19":"Net worth","dashboard.dashboard.Text.20":"ETH","dashboard.dashboard.Text.21":"Daily Growth","dashboard.dashboard.Text.22":"ETH","dashboard.dashboard.Text.23":"Weekly Growth","dashboard.dashboard.Text.24":"ETH","dashboard.dashboard.Text.25":"Yearly Growth","dashboard.dashboard.Text.26":"ETH","dashboard.dashboard.Text.27":"Net worth","dashboard.dashboard.Text.28":"ETH"}
  		...
  		return (
  			<div className={ classes.root }>
  				<div className={ classes.investedContainerLoggedOut }>
  					<Typography variant={'h5'} className={ classes.disaclaimer } id="dashboard.dashboard.Text.1" >{i18next.t('dashboard.dashboard.Text.1')}</Typography>
  					<div className={ classes.introCenter }>
  						<Typography variant='h3' id="dashboard.dashboard.Text.2" >{i18next.t('dashboard.dashboard.Text.2')}</Typography>
  					</div>
  				</div>
  			</div>
  		);
  		...
  		<div className={ classes.root }>
  			<div className={ classes.investedContainer}>
                ...
                <div className={ classes.inline }>
                	...
                	<Typography className={ classes.symbol } variant={ 'h3' } id="dashboard.dashboard.Text.3" >{i18next.t('dashboard.dashboard.Text.3')}</Typography>
                </div>
  						}
  						<Typography variant={ 'h4' } className={ classes.gray } id="dashboard.dashboard.Text.4" >{i18next.t('dashboard.dashboard.Text.4')}</Typography>
  					</div>
              ...
              <div className={ classes.titleBalance } onClick={ this.growthClicked }>
                  ...
                  <div className={ classes.inline }>
                  	...
                  	<Typography className={ classes.symbol } variant={ 'h3' } id="dashboard.dashboard.Text.5" >{i18next.t('dashboard.dashboard.Text.5')}</Typography>
                  </div>
              	}
              	<Typography variant={ 'h4' } className={ `${classes.gray} ${classes.prettyAlign}` } id="dashboard.dashboard.Text.6" >{i18next.t('dashboard.dashboard.Text.6')}</Typography>
              </div>
  					}
              ...
              <div className={ classes.titleBalance } onClick={ this.growthClicked }>
                  ...
                  <div className={ classes.inline }>
                  	...
                  	<Typography className={ classes.symbol } variant={ 'h3' } id="dashboard.dashboard.Text.7" >{i18next.t('dashboard.dashboard.Text.7')}</Typography>
                  </div>
              	}
              	<Typography variant={ 'h4' } className={ `${classes.gray} ${classes.prettyAlign}` } id="dashboard.dashboard.Text.8" >{i18next.t('dashboard.dashboard.Text.8')}</Typography>
              </div>
  					}
              ...
              <div className={ classes.titleBalance } onClick={ this.growthClicked }>
                  ...
                  <div className={ classes.inline }>
                  	...
                  	<Typography className={ classes.symbol } variant={ 'h3' } id="dashboard.dashboard.Text.9" >{i18next.t('dashboard.dashboard.Text.9')}</Typography>
                  </div>
              	}
              	<Typography variant={ 'h4' } className={ `${classes.gray} ${classes.prettyAlign}` } id="dashboard.dashboard.Text.10" >{i18next.t('dashboard.dashboard.Text.10')}</Typography>
              </div>
  					}
  				</div>
  				{ this.renderBasedOn() }
            ...
            <div className={ classes.vaultContainer }>
            	<Typography variant={ 'h3' } className={ classes.sectionHeading } id="dashboard.dashboard.Text.11" >{i18next.t('dashboard.dashboard.Text.11')}</Typography>
            	{ this.renderVaults() }
            </div>
  				}
  				{ (dashboard.assets && dashboard.assets.length > 0) &&
            <div className={ classes.earnContainer }>
            	<Typography variant={ 'h3' } className={ classes.sectionHeading } id="dashboard.dashboard.Text.12" >{i18next.t('dashboard.dashboard.Text.12')}</Typography>
            	{ this.renderEarn() }
            </div>
  				}
  			</div>
  	...
  	return vaults.map((asset) => {
  		return (<div className={ classes.vault } key={asset.id}>
            ...
            <div className={classes.heading}>
            	<Typography variant={ 'h5' } className={ classes.gray } id="dashboard.dashboard.Text.13" >{i18next.t('dashboard.dashboard.Text.13')}</Typography>
            	{ currency === 'USD' &&
                <div className={ classes.inline }>
                ...
                <div className={ classes.inline }>
                	...
                	<Typography className={ classes.symbol } variant={ 'h4' } id="dashboard.dashboard.Text.14" >{i18next.t('dashboard.dashboard.Text.14')}</Typography>
                	<Typography className={ classes.symbolAt } variant={ 'h4' }> @ </Typography>
                	<Typography className={ classes.symbol } variant={ 'h4' }> { (this._getAPY(asset)/365).toFixed(2) }%</Typography>
                </div>
            	}
  				...
  				{ growth === 1 &&
            <div className={classes.heading}>
            	<Typography variant={ 'h5' } className={ classes.gray } id="dashboard.dashboard.Text.15" >{i18next.t('dashboard.dashboard.Text.15')}</Typography>
            	{ currency === 'USD' &&
                <div className={ classes.inline }>
                ...
                <div className={ classes.inline }>
                	...
                	<Typography className={ classes.symbol } variant={ 'h4' } id="dashboard.dashboard.Text.16" >{i18next.t('dashboard.dashboard.Text.16')}</Typography>
                	<Typography className={ classes.symbolAt } variant={ 'h4' }> @ </Typography>
                	<Typography className={ classes.symbol } variant={ 'h4' }> { (this._getAPY(asset)/52).toFixed(2) }%</Typography>
                </div>
            	}
  				...
  				{ growth === 2 &&
            <div className={classes.heading}>
            	<Typography variant={ 'h5' } className={ classes.gray } id="dashboard.dashboard.Text.17" >{i18next.t('dashboard.dashboard.Text.17')}</Typography>
            	{ currency === 'USD' &&
                <div className={ classes.inline }>
                ...
                <div className={ classes.inline }>
                	...
                	<Typography className={ classes.symbol } variant={ 'h4' } id="dashboard.dashboard.Text.18" >{i18next.t('dashboard.dashboard.Text.18')}</Typography>
                	<Typography className={ classes.symbolAt } variant={ 'h4' }> @ </Typography>
                	<Typography className={ classes.symbol } variant={ 'h4' }> { (this._getAPY(asset)/1).toFixed(2) }%</Typography>
                </div>
            	}
  				...
  				<div className={classes.heading}>
  					<Typography variant={ 'h5' } className={ classes.gray } id="dashboard.dashboard.Text.19" >{i18next.t('dashboard.dashboard.Text.19')}</Typography>
              ...
              <div className={ classes.inline }>
              	...
              	<Typography className={ classes.symbol } variant={ 'h4' } id="dashboard.dashboard.Text.20" >{i18next.t('dashboard.dashboard.Text.20')}</Typography>
              </div>
  					}
  				</div>
  			</div>
  	...
  	return assets.map((asset) => {
  		return (<div className={ classes.vault } key={asset.id}>
  			<div className={ classes.assetSummary }>
  				...
  				{ growth === 0 &&
            <div className={classes.heading}>
            	<Typography variant={ 'h5' } className={ classes.gray } id="dashboard.dashboard.Text.21" >{i18next.t('dashboard.dashboard.Text.21')}</Typography>
            	{ currency === 'USD' &&
                <div className={ classes.inline }>
                ...
                <div className={ classes.inline }>
                	...
                	<Typography className={ classes.symbol } variant={ 'h4' } id="dashboard.dashboard.Text.22" >{i18next.t('dashboard.dashboard.Text.22')}</Typography>
                	<Typography className={ classes.symbolAt } variant={ 'h4' }> @ </Typography>
                	<Typography className={ classes.symbol } variant={ 'h4' }> { (asset.maxApr ? (asset.maxApr*100/365).toFixed(2) : '0.00') }%</Typography>
                </div>
            	}
  				...
  				{ growth === 1 &&
            <div className={classes.heading}>
            	<Typography variant={ 'h5' } className={ classes.gray } id="dashboard.dashboard.Text.23" >{i18next.t('dashboard.dashboard.Text.23')}</Typography>
            	{ currency === 'USD' &&
                <div className={ classes.inline }>
                ...
                <div className={ classes.inline }>
                	...
                	<Typography className={ classes.symbol } variant={ 'h4' } id="dashboard.dashboard.Text.24" >{i18next.t('dashboard.dashboard.Text.24')}</Typography>
                	<Typography className={ classes.symbolAt } variant={ 'h4' }> @ </Typography>
                	<Typography className={ classes.symbol } variant={ 'h4' }> { (asset.maxApr ? (asset.maxApr*100/52).toFixed(2) : '0.00') }%</Typography>
                </div>
            	}
  				...
  				{ growth === 2 &&
            <div className={classes.heading}>
            	<Typography variant={ 'h5' } className={ classes.gray } id="dashboard.dashboard.Text.25" >{i18next.t('dashboard.dashboard.Text.25')}</Typography>
            	{ currency === 'USD' &&
                <div className={ classes.inline }>
                ...
                <div className={ classes.inline }>
                	...
                	<Typography className={ classes.symbol } variant={ 'h4' } id="dashboard.dashboard.Text.26" >{i18next.t('dashboard.dashboard.Text.26')}</Typography>
                	<Typography className={ classes.symbolAt } variant={ 'h4' }> @ </Typography>
                	<Typography className={ classes.symbol } variant={ 'h4' }> { (asset.maxApr ? (asset.maxApr*100).toFixed(2) : '0.00') }%</Typography>
                </div>
            	}
  				...
  				<div className={classes.heading}>
  					<Typography variant={ 'h5' } className={ classes.gray } id="dashboard.dashboard.Text.27" >{i18next.t('dashboard.dashboard.Text.27')}</Typography>
  					{ currency === 'USD' && <Typography variant={ 'h3' } noWrap>$ { parseFloat(asset.usdBalance ? (asset.usdBalance).toFixed(2) : '0.00').toLocaleString() }</Typography > }
  					{ currency === 'ETH' &&
              <div className={ classes.inline }>
              	<Typography variant={ 'h3' } noWrap>{ parseFloat(asset.ethBalance ? (asset.ethBalance).toFixed(2) : '0.00').toLocaleString() }</Typography >
              	<Typography className={ classes.symbol } variant={ 'h4' } id="dashboard.dashboard.Text.28" >{i18next.t('dashboard.dashboard.Text.28')}</Typography>
              </div>
  					}
  				</div>
  			</div>
