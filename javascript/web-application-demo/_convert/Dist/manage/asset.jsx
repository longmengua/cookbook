//i18n => {"manage.asset.Text.1":"Recommend","manage.asset.Text.2":"Donate","manage.asset.Text.3":"Rebalance"}
  		...
  		<div className={ classes.tradeContainer }>
  			...
  			<div className={ classes.scaleContainer }>
  				...
  				<Button
  					...
  					<Typography variant={'h5'} id="manage.asset.Text.1" >{i18next.t('manage.asset.Text.1')}</Typography>
  				</Button>
  			</div>
  			<div className={ classes.scaleContainer }>
  				<Button
  				...
  				>
  					<Typography className={ classes.buttonText } variant={ 'h5'} color='secondary' id="manage.asset.Text.2" >{i18next.t('manage.asset.Text.2')}</Typography>
  				</Button>
  			</div>
  		</div>
  		<div className={classes.tradeContainer}>
  			...
  			<div className={ classes.scaleContainer }>
  				...
  				>
  					<Typography className={ classes.buttonText } variant={ 'h5'} color='secondary' id="manage.asset.Text.3" >{i18next.t('manage.asset.Text.3')}</Typography>
  				</Button>
  			</div>
  		</div>
  	</div>);
