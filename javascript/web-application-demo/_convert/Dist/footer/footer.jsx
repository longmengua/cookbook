			...
			<div className={classes.footer}>
				<div className={ classes.builtWith }>
					...
					<div  className={ `${classes.link} ${classes.builtWithLink}` } onClick={ () => { this.builtWithOverlayClicked(); } } >
						...
						<Typography variant={ 'h4'}  id="footer.footer.Text.2" >{i18next.t('footer.footer.Text.2')}</Typography>
					</div>
				</div>
				...
				<div className={ classes.community }>
					<Typography className={ classes.heading } variant={ 'h6'} id="footer.footer.Text.9" >{i18next.t('footer.footer.Text.9')}</Typography>
					...
					<div  className={ classes.link } onClick={()=> window.open("https://yearn.snapshot.page", "_blank")} >
						...
						<Typography variant={ 'h4'}  id="footer.footer.Text.14" >{i18next.t('footer.footer.Text.14')}</Typography>
					</div>
				...
				<div className={ classes.socials }>
					...
					<div  className={ classes.link } onClick={()=> window.open("https://github.com/iearn-finance", "_blank")} >
						...
						<Typography variant={ 'h4'}  id="footer.footer.Text.21" >{i18next.t('footer.footer.Text.21')}</Typography>
					</div>
				</div>
